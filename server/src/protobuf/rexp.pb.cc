...
void protobuf_AddDesc_rexp_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "MPLX\022\017\n\004real\030\001 \001(\001:\0010\022\014\n\004imag\030\002 \002(\001B-\n\037c"
    "om.simple.rprotoserve.protobufB\nREXPProt"
    "os", 682);
...
const REXP& REXP::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_rexp_2eproto();  return *default_instance_;
}
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_attrName:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->attrname(0).data(), this->attrname(0).length(),
